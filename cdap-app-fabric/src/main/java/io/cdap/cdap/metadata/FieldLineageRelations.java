 ...
 */
public class FieldLineageRelations {
  private final DatasetId entityId;
  private final Set<FieldRelation> relations;

  public FieldLineageRelations(DatasetId entityId, Set<FieldRelation> relations) {
  ...
  public boolean equals(Object o) {
    ...
    FieldLineageRelations that = (FieldLineageRelations) o;
